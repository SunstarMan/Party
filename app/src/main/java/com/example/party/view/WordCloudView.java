package com.example.party.view;
...
public class WordCloudView extends FrameLayout implements View.OnClickListener {
    ...
    private HashSet<View> placed = new HashSet<>();
    ...
    private LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    private float[] rotates = {0f, 90f, 270f};
